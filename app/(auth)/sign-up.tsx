      ...
      >
        ...
        >
          ...
          <View className="items-center w-full">
            <Text className="text-text-primary text-3xl font-bold mb-1 text-center">Create account</Text>
            <Text className="text-text-muted text-sm mb-8 text-center">Set up your parent account to get started.</Text>
            ...
            <Text className="text-text-muted text-xs mb-3 self-start">This is how your family will be identified in the app.</Text>
            <TextInput
            ...
            <Text className="text-text-muted text-xs mb-3 self-start">We will use this to contact you and secure your account.</Text>
            <TextInput
              id="input-email"
              value={email}
            ...
            <Text className="text-text-muted text-xs mb-3 self-start">Must be at least 8 characters long.</Text>
            <View className="relative justify-center mb-3 w-full">
              <TextInput
                id="input-password"
                value={password}
